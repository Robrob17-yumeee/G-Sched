        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('admin.availability.store') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="add_guidance_associate" class="form-label">Guidance Associate <span class="text-danger">*</span></label>
                        <select class="form-select" id="add_guidance_associate" name="guidance_associate_id" required>
                            ...
                            @foreach($guidanceAssociates as $associate)
                                <option value="{{ $associate->id }}">{{ $associate->full_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-body">
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="small">Available — has availability with open slots</span>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                        <div class="rounded" style="width: 16px; height: 16px; background: var(--orange);"></div>
                        <span class="small">Booked — has appointments scheduled</span>
                    </div>
                    <div class="d-flex align-items-center gap-3">
