            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.users.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('student_id') is-invalid @enderror" id="student_id" name="student_id" value="{{ old('student_id') }}" placeholder="xx-x-xxxxx (e.g., 23-1-12345)" pattern="^\d{2}-\d-\d{5}$">
                        @error('student_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('age') is-invalid @enderror" id="age" name="age" value="{{ old('age') }}" min="12" max="100">
                            @error('age')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
